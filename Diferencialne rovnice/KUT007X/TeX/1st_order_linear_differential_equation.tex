...
\end{align}
kde $N$ je konštanta $N = -M$, integrály sme zjednotili na základe predpokladu, že $t \in \left< t_i, t_f \right>$, teda integrály na intervale $\left< t_i, t \right>$ sa navzájom odčítajú.
